...
if [ "$1" != "" ]; then
	...
	if [ $? == 0 ]; then
		...
		ssh opi@$hostname 'rm -r /home/opi/ros2_ws/src/barometer'
		
		echo ">>Copying files to opi@$hostname"
		ssh opi@$hostname 'mkdir -p /home/opi/ros2_ws/src/barometer'
		scp -r ./* opi@$hostname:/home/opi/ros2_ws/src/barometer
