...
void BerryIMU_v3::readFrom(int device, byte address, int num, byte buff[]) {
  ...
  Serial.println("rF_3");
  int val = Wire.endTransmission(); //end transmission
  Serial.print("rF_3: ");
  Serial.println(val);
  Serial.println("rF_4");
